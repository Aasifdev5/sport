...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">EditMatches</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">EditMatches</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-md-6">
                ...
                @endif
              <!-- form start -->
                <form action="{{route('matches.update',[$edit->id])}}" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <input type="Date" class="form-control" name="date" id="date" value="{{$edit->date}}"placeholder="Enter Team">
                    </div>
                    @error('date')
                ...
                @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" name="time" value="{{$edit->time}}" id="pos" placeholder="Enter POS">
                                </div>
                                @error('time')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
